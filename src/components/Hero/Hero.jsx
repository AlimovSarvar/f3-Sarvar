...
import './Hero.scss'
import Calendar from '../../assets/img/hero-calendar.png'
import Class from '../../assets/img/hero-men-class.png'
import Message from '../../assets/img/hero__pochta.png'
import Voice from '../../assets/img/hero-voice.png'
import Watch from '../../assets/img/hero-watch.png'
import Background from '../../assets/img/her-background.png'
function Hero() {
  return (
    <div className='Hero'>
        <div className="container">
          <div className="hero-innner">
           <img className='hero-backgroundimg' src={Background} alt="img" />
